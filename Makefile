...
SRC_TEST =	main_test.c split_quotes.c trim_quotes.c split_command.c  final_split.c ft_gest_ambiental.c ft_check_syntax.c \
			ft_create_cmds.c ft_create_node.c ft_quit.c ft_heredoc.c ft_exe.c ft_signals.c ft_builtins.c

UTILS =		utils1.c utils2.c utils3.c utils1_free.c utils_print.c 
